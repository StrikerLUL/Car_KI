...
class SimRacingEditorGUI:
    ...
    def _build_ui(self):
        ...
        effects = [
            ...
            ("use_camera_shake", "Camera-Shake", True),
            ("use_mirror_x", "Mirror X (Zufall)", True),
    ...
    def _run(self):
        ...
        config = PipelineConfig(
            ...
            use_camera_shake=self.vars["use_camera_shake"].get(),
            use_mirror_x=self.vars["use_mirror_x"].get(),
